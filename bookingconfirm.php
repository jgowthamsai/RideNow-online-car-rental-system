...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <ul class="nav navbar-nav">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Bookings <span class="caret"></span> </a>
                <ul class="dropdown-menu">
    ...
    <h2 class="text-center"> Thank you for using RIDE NOW Services! We wish you have a safe ride. </h2>
...
<body>
	<center>
		...
		<button class="btn" style="width:100%">
			<i class="fa fa-download" onclick="print().bookingconfirm">Download</i>
...
<footer class="site-footer"> 
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h5>© <?php echo date("Y"); ?> RIDE NOW BY GOWTHAM</h5>
            </div>
        </div>
    </div>
</footer>
